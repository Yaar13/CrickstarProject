...
worldMatch1.Team1Score = 250        //team 1 wins here
...
worldMatch1.matchNumber = 3
worldMatch1.matchType = MatchType.PlayOffs
worldMatch1.Team1 = team5
worldMatch1.Team2 = team6
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 313         //team 5 wins here
worldMatch1.Team2Score = 310
worldMatch1.ballType = BallType.WhiteBall


var worldMatch4: WorldCup = WorldCup()
worldMatch1.matchNumber = 4
worldMatch1.matchType = MatchType.PlayOffs
worldMatch1.Team1 = team1
worldMatch1.Team2 = team4
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 220                //team 1 wins here
worldMatch1.Team2Score = 210
worldMatch1.ballType = BallType.WhiteBall


var worldMatch5: WorldCup = WorldCup()
worldMatch1.matchNumber = 5
worldMatch1.matchType = MatchType.PlayOffs
worldMatch1.Team1 = team2
worldMatch1.Team2 = team3
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 302               //team 2 wins here
worldMatch1.Team2Score = 257
worldMatch1.ballType = BallType.WhiteBall


var worldMatch6: WorldCup = WorldCup()
worldMatch1.matchNumber = 6
worldMatch1.matchType = MatchType.PlayOffs
worldMatch1.Team1 = team5
worldMatch1.Team2 = team3
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 250          //team 5 wins here
worldMatch1.Team2Score = 159
worldMatch1.ballType = BallType.WhiteBall
...
worldMatch1.matchNumber = 7
worldMatch1.matchType = MatchType.quarterfinals
worldMatch1.Team1 = team1
worldMatch1.Team2 = team4
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 333     //team 1 wins here
worldMatch1.Team2Score = 312
worldMatch1.ballType = BallType.WhiteBall

var worldMatch8: WorldCup = WorldCup()
worldMatch1.matchNumber = 7
worldMatch1.matchType = MatchType.quarterfinals
worldMatch1.Team1 = team5  //team 5 wins here
worldMatch1.Team2 = team3
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 312     // team 5 wins here
worldMatch1.Team2Score = 309
worldMatch1.ballType = BallType.WhiteBall


var worldMatch9: WorldCup = WorldCup()
worldMatch1.matchNumber = 9
worldMatch1.matchType = MatchType.quarterfinals
worldMatch1.Team1 = team2
worldMatch1.Team2 = team6
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 264
worldMatch1.Team2Score = 261     //team 2 wins here
worldMatch1.ballType = BallType.WhiteBall


var worldMatch10 : WorldCup = WorldCup()
worldMatch1.matchNumber = 10
worldMatch1.matchType = MatchType.quarterfinals
worldMatch1.Team1 = team3
worldMatch1.Team2 = team4
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 202
worldMatch1.Team2Score = 204        //team 4 wins here
worldMatch1.ballType = BallType.WhiteBall
...
worldMatch1.matchNumber = 11
worldMatch1.matchType = MatchType.SemiFinals
worldMatch1.Team1 = team1
worldMatch1.Team2 = team5
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 378
worldMatch1.Team2Score = 377      // team 1 wins here
worldMatch1.ballType = BallType.WhiteBall

var worldMatch12: WorldCup = WorldCup()
worldMatch1.matchNumber = 12
worldMatch1.matchType = MatchType.SemiFinals
worldMatch1.Team1 = team2
worldMatch1.Team2 = team4
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 275
worldMatch1.Team2Score = 256     //team 2 wins here
worldMatch1.ballType = BallType.WhiteBall
...
worldMatch1.matchNumber = 13
worldMatch1.matchType = MatchType.quarterfinals
worldMatch1.Team1 = team1
worldMatch1.Team2 = team2
worldMatch1.oversFormat = OversFormat.FiftyOvers
worldMatch1.Team1Score = 412
worldMatch1.Team2Score = 411      //team 1 wins here
worldMatch1.ballType = BallType.WhiteBall
...
// ****************CHAMPIONS TROPHY LEAGUE STARTS HERE**********************
